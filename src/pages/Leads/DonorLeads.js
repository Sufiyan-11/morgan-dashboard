...
function DonorLeads(props) {
  ...
  const getPostData = () => {
    ...
    firebase.database().ref(`donor`).get()
    .then((response) => {
    ...
    const handleDelete = (postId, e) => {
      ...
      // .delete(`https://educaretech-dashboard-default-rtdb.firebaseio.com/contactLead/${postId}.json`)
        firebase.database().ref(`donor/${postId}`).remove()
        .then((response) => {
          alert("donor lead deleted succesfully");
    ...
    <div className="container-fluid main bg-light py-5">
        <div className="row justify-content-center">
            ...
            <div className="add-teacher-profile pb-3">
                    <div className="title">
                        <h2 id="teach_profile">Enquire Donor Leads</h2>
                    </div>
                </div>
              <div class="form-row">
