      ...
      file =>
        new Promise((resolve, reject) => {
          ...
          let uploadTask = storage
            .child(`/images/painting/${file.name}`)
            .put(file, metadata);
          uploadTask.on(
...
function Blogs(props) {
  ...
  function handleUpload(e) {
    ...
    const uploadTask = storage.ref(`/images/painting/${time + "_" + file.name}`).put(file);
  ...
  const handleAddPostData = (e) => {
    ...
    if (postPositions.current.value.length === 0 || postTopics.current.value.length === 0) {
      ...
      if (editDetails) {
        ...
        firebase.database().ref(`painting/${postId}`).set(
          {
          ...
          .then((response) => {
            alert("painting edited succesfully");
      ...
      //  if user wants to add a new card
        ...
        firebase.database().ref('painting/').push(
          {
          ...
          .then((response) => {
            alert("painting added succesfully");
  ...
  const handleDelete = (postId, e) => {
    if (window.confirm("Are you sure you want to delete the painting?")) {
      // Axios
      // .delete(`https://educaretech-dashboard-default-rtdb.firebaseio.com/SessionData/${postId}.json`)
      firebase.database().ref(`painting/${postId}`).remove()
        .then((response) => {
          alert("painting deleted succesfully");
          window.location.reload();
          ...
          <div className="modal-dialog modal-lg" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">{editDetails ? "Edit paintings" : "Add paintings"}</h5>
              ...
              <div className="modal-body">
                <form onSubmit={handleUpload}>
                  ...
                  <div className="form-group">
                    <label for="topic">Title Name</label>
            ...
            <div className="col-lg-11">
              ...
              <div className="add-teacher-profile pb-3">
                <div className="d-flex justify-content-between">
                  <div className="title">
                    <h2 id="teach_profile">Paintings</h2>
              ...
              <div className="form-row">
                <div className="form-group col-md-11">
                  <label for="inputEmail4">Search based on Painting Name</label>
